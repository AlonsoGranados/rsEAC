...
def readParser():
    ...
    parser.add_argument('--env_name', default="InvertedPendulum-v4")
    parser.add_argument('--lr', default=3e-4, type=float, help='learning rate')
    parser.add_argument('--beta', default=1.0, type=float, help='learning rate')
    parser.add_argument('--algo', default='stable')
    parser.add_argument('--num_epoch', default=4000,
                        help='total number of epochs')
    parser.add_argument('--experiment_num', default=5,
...
def experiment(args, env, eval_env, policy, replay_buffer, save_dir):
    ...
    for t in range(max_timesteps):
        ...
        if (t+1) % eval_freq == 0:
            ...
            # eval_r_mean_var = eval_r_mean - args.lam * eval_r.var()
...
def main():
    ...
    # eval_env = gym.make(args.env_name, exclude_current_positions_from_observation=False)
    #
    ...
    # create save dir
    save_dir = get_save_dir(args.env_name,args.algo, args.beta, args.experiment_num)
    ...
    print('env:', args.env_name, 'beta:', args.beta, 'lr:', lr, 'seed:', args.experiment_num)
